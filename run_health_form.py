...
if submit:
    ...
    st.markdown(f"<h2 style='color:blue'>{t['prediction_is']}: {max_pred_label_translated}</h2>", unsafe_allow_html=True)

    # Table with translated numbers and localized header
